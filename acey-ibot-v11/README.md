...
- **`train_ibot_stable_11.sh`**: Conservative settings (lr=0.0003, mask_ratio=0.4, wd=0.04→0.1)
- **`train_ibot_balanced_11.sh`**: Moderate settings (lr=0.0005, mask_ratio=0.35, wd=0.05→0.15)
- **`train_ibot_peak_lr_11.sh`**: Peak LR schedule (warmup to 0.001, then decay)
...
- `train_ibot_stable_11.sh`, `train_ibot_balanced_11.sh`, `train_ibot_peak_lr_11.sh`: SLURM training scripts (3 variants)
...
sbatch train_ibot_stable_11.sh

# Balanced configuration (moderate settings)
sbatch train_ibot_balanced_11.sh

# Peak LR configuration (follows feedback exactly)
sbatch train_ibot_peak_lr_11.sh
```
