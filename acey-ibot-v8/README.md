...
- **`train_ibot_conservative_8.sh`**: Stable AdamW baseline (lr=0.0003, mask_ratio=0.3, wd=0.04→0.1, ViT-tiny)
- **`train_ibot_aggressive_8.sh`**: High-capacity LARS training (lr=0.1, mask_ratio=0.4, blockwise masking, ViT-small)
- **`train_ibot_feedback_8.sh`**: Strictly follows training feedback (lr=0.0003, max_lr=0.001, batch_size=96, all recommendations)
...
- `train_ibot_conservative_8.sh`, `train_ibot_aggressive_8.sh`, `train_ibot_feedback_8.sh`: SLURM training scripts (3 diverse variants)
