...
## Conservative Configuration (`train_ibot_conservative_8.sh`)
...
## Aggressive Configuration (`train_ibot_aggressive_8.sh`)
...
## Feedback Configuration (`train_ibot_feedback_8.sh`)
...
Run any variant:
```bash
sbatch train_ibot_conservative_8.sh    # Stable baseline
sbatch train_ibot_aggressive_8.sh      # High-capacity exploration
sbatch train_ibot_feedback_8.sh        # Follows feedback exactly
```

## Which One to Use?

### Start with Conservative (`train_ibot_conservative_8.sh`)
...
### Try Aggressive (`train_ibot_aggressive_8.sh`) if:
...
### Use Feedback (`train_ibot_feedback_8.sh`) if:
