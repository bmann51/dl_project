...
(macey v6 uses the same constraint as previous versions.)
"""
...
if __name__ == "__main__":
    print("Checking ViT backbone parameter counts for competition compliance (macey v6)...")
    ...
    print("NOTE")
    print("="*60)
    print("The assignment requires BACKBONE parameters < 100M.")
