...
- **`train_ibot_conservative_3.sh`**: Stable AdamW baseline (lr=0.0003, mask_ratio=0.3, wd=0.04→0.1, ViT-tiny)
- **`train_ibot_aggressive_3.sh`**: High-capacity LARS training (lr=0.1, mask_ratio=0.4, blockwise masking, ViT-small)
- **`train_ibot_feedback_3.sh`**: Strictly follows training feedback (lr=0.0003, max_lr=0.001, batch_size=96, all recommendations)
...
- `train_ibot_conservative_3.sh`, `train_ibot_aggressive_3.sh`, `train_ibot_feedback_3.sh`: SLURM training scripts (3 diverse variants)
