"""
Submission script for iBOT v10 trained models
...
Usage:
    python generate_submission_ibot.py \
        ...
        --output submission_ibot_v10.csv \
        --arch vit_base \
        --resolution 96 \
        --k 5
"""
...
import argparse
import timm
from ibot_ssl_v10 import ViTBackbone
...
def load_v10_model(checkpoint_path, arch='vit_base', img_size=96, device='cuda'):
    """Load v10 iBOT model from checkpoint (backbone only)"""
    
    print(f"Loading v10 iBOT checkpoint: {checkpoint_path}")
    ...
    if arch == 'vit_base':
        ...
        raise ValueError(f"Unsupported architecture for v10: {arch}")
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, required=True,
                        help='Path to iBOT v10 checkpoint')
