...
## Conservative Configuration (`train_ibot_conservative_5.sh`)
...
## Aggressive Configuration (`train_ibot_aggressive_5.sh`)
...
## Feedback Configuration (`train_ibot_feedback_5.sh`)
...
Run any variant:
```bash
sbatch train_ibot_conservative_5.sh    # Stable baseline
sbatch train_ibot_aggressive_5.sh      # High-capacity exploration
sbatch train_ibot_feedback_5.sh        # Follows feedback exactly
```

## Which One to Use?

### Start with Conservative (`train_ibot_conservative_5.sh`)
...
### Try Aggressive (`train_ibot_aggressive_5.sh`) if:
...
### Use Feedback (`train_ibot_feedback_5.sh`) if:
